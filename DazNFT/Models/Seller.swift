...
var sellers = [
    ...
    SellerModel(index: 2, profileImageName: "seller2", name: "Ozge", price: "$123.45", isFollowing: true, followersCounter: 30),
    SellerModel(index: 3, profileImageName: "seller1", name: "Emir", price: "$123.45", isFollowing: true, followersCounter: 20),
    SellerModel(index: 4, profileImageName: "seller2", name: "Ozge", price: "$123.45", isFollowing: true, followersCounter: 40),
    SellerModel(index: 5, profileImageName: "seller1", name: "Emir", price: "$123.45", isFollowing: true, followersCounter: 50),
    SellerModel(index: 6, profileImageName: "seller2", name: "Ozge", price: "$123.45", isFollowing: true, followersCounter: 10),
    ...
    SellerModel(index: 10, profileImageName: "seller2", name: "Ozge", price: "$123.45", isFollowing: true),
]
